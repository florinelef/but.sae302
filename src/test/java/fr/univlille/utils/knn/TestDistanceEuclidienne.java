...
public class TestDistanceEuclidienne {
    ...
    public void setup() {
        ...
        this.distanceEuclidienne = new DistanceEuclidienne();
    }

    @Test
    public void testDistance() {
        double expectedResult = Math.sqrt(1 + Math.pow(1.5 - 255, 2) + 0);
        assertEquals(expectedResult, distanceEuclidienne.distance(donnee1, donnee2));
        expectedResult = Math.sqrt(1 + Math.pow(1.5-1, 2) + 1);
        assertEquals(expectedResult, distanceEuclidienne.distance(donnee1, donnee3));
        expectedResult = 0;
        assertEquals(expectedResult, distanceEuclidienne.distance(donnee1, donnee1));
    }
}
